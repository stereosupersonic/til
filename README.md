...
- [new rails6](rails/new_rails6.md)
- [new rails7](rails/new_rails7.md)
- [notifications active support](rails/notifications_active_support.md)
...
- [send emails](rails/send_emails.md)
- [serialize to poro](rails/serialize_to_poro.md)
- [show chunks of text](rails/show_chunks_of_text.md)
...
- [bundler tips](ruby/bundler_tips.md)
